        ...
        <>
            <section className='container mx-auto'>
                <div className="px-30 py-10 flex flex-col items-center gap-10">
                    <h1 className="text-4xl text-center font-bold">The Brave Little Steps: Philip&apos;s Potty Adventure</h1>

                    <div className='px-4 mt-4'>
                        <Image src={story4} alt='' className='rounded-lg object-cover xl:float-left pr-4 '/>
                        <p className='text-lg pt-6 xl:text-2xl xl:pt-0 leading-6 text-justify'><span className='font-semibold text-5xl'>O</span>nce upon a time, in a little town, there lived a small boy named Philip. Philip was already a big boy, but he was still learning certain things. His parents always told him that one of the most important skills he needed to master was using the potty. 
