        ...
        <>
            <section className='container mx-auto'>
                <div className="px-30 py-10 flex flex-col items-center gap-10">
                    <h1 className="text-4xl text-center font-bold">Duckling</h1>

                    <div className='px-4 mt-4'>
                        <Image src={story3} alt='' className='rounded-lg object-cover xl:float-left pr-4'/>
                        <p className='text-lg pt-6 xl:text-2xl xl:pt-0 leading-6 text-justify'><span className='font-semibold text-5xl'>O</span>nce upon a sunny day in a small village, there lived a duckling named Katie. Katie was very curious about the world and loved running around the meadow with her siblings. 
